...
namespace RegistrationForm
{
    public partial class AdminDashboard : Form
    {
        ...
        private void btnStatistics_Click(object sender, EventArgs e)
        {
            ...
            statistics.LoadPieChartFromTH();
            statistics.LoadPieChartFromSub();
            statistics.LoadPieChartFromSP();
            statistics.LoadEnrollmentSplineChart();
        }
        ...
        {
            ResetButtonColors();
            btnTeacherList.BackColor = Color.Gray;
        ...
        {
            ResetButtonColors();
            btnStudentList.BackColor = Color.Gray;
        ...
        private void ResetButtonColors()
        {
            ...
            btnStudentList.BackColor = Color.White;
            btnAddTeacher.BackColor = Color.White;
            btnTeacherList.BackColor = Color.White;
        }
    }
}
