...
namespace RegistrationForm.AdminDashvoardMdiPages.Students
{
    public partial class StudentList : Form
    {
        ...
        public StudentList()
        {
            ...
            if (dgvStudents.Columns[6] is DataGridViewTextBoxColumn textBoxColumn)
            {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            string phone = dgvStudents.Rows[r].Cells[6].Value.ToString();
            ...
            if (dr == DialogResult.OK)
            {
                ...
                {
                    repos.UpdateStudent(id, enrollmentDate, firstname, lastname, age, gender, phone, address, email, status);
