...
namespace RegistrationForm.AdminDashvoardMdiPages.Subjects
{
    public partial class Subjects : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                if(isDataMofied == true || dgvSubjects.Rows[r].Cells[5].Value.ToString() == "Active")
                {
                ...
                {
                    MessageBox.Show("Nothing to inactive", "Abort", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            ...
            foreach (Control control in GetAllControls(panel3))
            {
